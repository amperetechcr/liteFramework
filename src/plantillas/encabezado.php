...
$enlacesNav = [
    ...
    'auditoria' => ['ruta' => '/auditoria', 'etiqueta' => 'Auditora', 'icono' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>'],
    ...
    'rendimiento' => ['ruta' => '/rendimiento', 'etiqueta' => 'Rendimiento', 'icono' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>'],
    ...
    'diagnostico' => ['ruta' => '/diagnostico', 'etiqueta' => 'Diagnostico', 'icono' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>'],
    'visualizador' => ['ruta' => '/oficina', 'etiqueta' => 'PixelAmpCrew', 'icono' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/></svg>'],
    ...
    'estadisticas' => ['ruta' => '/estadisticas', 'etiqueta' => 'Estadsticas', 'icono' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>'],
...
<?php
$cssDir = DIRECTORIO_RAIZ . '/src/css';
$cssFiles = ['tema', 'paletas', 'maquetacion', 'componentes', 'modales', 'subirArchivos',
    'generadorPdf', 'estadisticas', 'rendimiento', 'documentacion', 'apariencia',
    'estilos', 'utilidades', 'personalizacion', 'disenos'];
foreach ($cssFiles as $f): $path = $cssDir . '/' . $f . '.css'; $v = file_exists($path) ? filemtime($path) : '1'; ?>
    <link rel="stylesheet" href="<?= URL_BASE ?>/src/css/<?= $f ?>.css?v=<?= $v ?>">
<?php endforeach; ?>
    <script type="module" src="<?= URL_BASE ?>/src/js/principal.js?v=<?= filemtime(DIRECTORIO_RAIZ . '/src/js/principal.js') ?>"></script>
...
>
    ...
    <div class="contenedor-principal envoltura-principal" id="envoltura-principal">
        ...
        <nav class="barra-lateral" id="barra-lateral" aria-label="Navegacin principal">
            ...
            <div class="barra-lateral-pie">
                ...
                <a href="<?= URL_BASE ?>/salir" class="accion-boton variante-borde ancho-auto margen-superior-0 margen-inferior-normal margen-izquierdo-normal margen-derecho-normal" aria-label="Cerrar sesin">Salir</a>
            </div>
        </nav>

        <div class="area-contenido">
            <header class="cabecera-movil">
                <button type="button" id="boton-menu-lateral" class="boton-menu-lateral" aria-label="Abrir men" aria-expanded="false"></button>
