...
[![Assertions](https://img.shields.io/badge/assertions-757-royalblue)](tests/)
...
[![PSR-4](https://img.shields.io/badge/PSR--4-%E2%9C%85-blueviolet)](composer.json)
...
| **Testing** | 311 tests / 757 aserciones, PHPUnit phar (sin Composer), SQLite in-memory, CI integrado |
...
# Resultado: 311 tests, 757 aserciones, SQLite in-memory
```
